    ...
    def api_query(self, command, req={}):
        ...
        if (command == "returnTicker" or command == "return24Volume"):
            ...
            ret = urllib.request.urlopen(
                'https://poloniex.com/public?command=' + command + '&currencyPair=' + str(req['currencyPair']) + '&depth=10')
            return json.loads(ret.read().decode('utf8'))
            ...
            if any(self.APIKey==None,self.Secret==None):
                return {'asks': [{'price': 0, 'amount': 0}], 'bids': [{'price': 0, 'amount': 0}]}
